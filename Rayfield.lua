...
function RayfieldLibrary:CreateWindow(Settings)
	...
	LoadingFrame.Title.Text = Settings.LoadingTitle or "NebulaScripts"
	LoadingFrame.Subtitle.Text = Settings.LoadingSubtitle or "Interface Suite"

	if Settings.LoadingTitle ~= "NebulaScripts" then
		LoadingFrame.Version.Text = "NebulaScripts"
	end
